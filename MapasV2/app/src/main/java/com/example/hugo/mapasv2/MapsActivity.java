package com.example.hugo.mapasv2;
...
//                        .show();
    ...
    private void startGettingLocations()
    {
        ...
        long MIN_DISTANCE_CHANGE_FOR_UPDATES = 10;// Distancia em metros
        long MIN_TIME_BW_UPDATES = 1000 * 10;// Tempo em milisegundos

        // Adiciona as permissões em listas
        ArrayList<String> permissions = new ArrayList<>();
        ArrayList<String> permissionsToRequest;

//        permissions.add(android.Manifest.permission.ACCESS_FINE_LOCATION);
        permissions.add(android.Manifest.permission.ACCESS_COARSE_LOCATION);
        permissionsToRequest = findUnAskedPermissions(permissions); // Verifica as permissões ainda não dadas
